...
// **.cilium.io. matches  anysub.cilium.io. andmomre subdomains.
// **.ci*.io. matches anysub.cilium.io. anysub.ci.io. and more subdomains anysub.ciliumandmore.io. but not cilium.io.
func (ts *MatchPatternTestSuite) TestAnchoredMatchPatternMatching(c *C) {
	for _, testCase := range []struct {
		...
		// Tests including ** which requires 1+ occurence of characters, double dot is not accepted
		{
			pattern: "**.cilium.io.",
